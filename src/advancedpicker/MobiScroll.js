define([
  ...
  return declare("advancedpicker.MobiScroll", [ _WidgetBase ], {
    ...
    buildRendering : function() {
        ...
        var getNames = dojoDate.getNames;
        ...
        this._input.scroller({
            ...
            onShow          : lang.hitch(this, "eventOnShow"),
            onSelect        : lang.hitch(this, "eventOnSelect"),
            onCancel        : lang.hitch(this, "eventOnCancel"),
    ...
    setupEventHandlers : function() {
        ...
        this._input.bind("change", lang.hitch(this, "eventInputChanged"));
        this._input.bind("focus", lang.hitch( this, function() {
        	dojoQuery( "#" + domAttr.get( this.domNode, "id" ) + " + .alert" ).forEach( domConstruct.destroy );
        }));
    },
    ...
    update : function(obj, callback) {
		...
		this._validationHandle = mx.data.subscribe({
			...
			callback: lang.hitch( this, function( _validations_ ){
				...
				_validations_.forEach( function( validation, index, array ){
					...
					if( message ){
						...
						dojoQuery( "#" + domAttr.get( this.domNode, "id" ) + " + .alert" ).forEach( dojo.destroy );
						domConstruct.place( "<div class='alert alert-danger'>" + message + "</div>", this.domNode, "after" );
    ...
    refresh : function(callback) {
        ...
        if (this._mxObject) {
            ...
            if (typeof(date) == "number" && !isNaN(date) && date !== 0) {
                domClass.remove(this.domNode, "advancedpickerMobiScroll_unset");

                date = new Date(date);
                this._input.scroller("setDate", date, true);
                this._setCaption(this._inputNode.value);
            } else {
                domClass.add(this.domNode, "advancedpickerMobiScroll_unset");
    ...
    _setCaption : function(text) {
        ...
        domAttr.set(this._inputNode, "placeholder", text);
        this._readNode.innerHTML = text ? dom.escapeString(text) : "&nbsp;";
    },
